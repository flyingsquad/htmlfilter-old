...
export class HTMLFilter {
	...
	async createtab() {
		...
		console.log(`htmlfilter | ${filterURL}`);
	...
	filter(actor) {
		...
		console.log(`htmlfilter | Filtering ${actor.name}`);
		
		this.directives(this.body);
	}

	static {
		// console.log("htmlfilter | HTML character filter loaded.");

		Hooks.on("init", function() {
		  // console.log("htmlfilter | HTML character filter initialized.");
		});

		Hooks.on("ready", function() {
		  // console.log("htmlfilter | HTML character filter ready to accept game data.");
		});
	}
}
...
Hooks.on("renderActorDirectory", (app, html, data) => {
    console.log("htmlfilter | Creating actor tab button");

    const filterButton = $("<button id='htmlfilter-button'><i class='fas fa-file-text'></i></i>HTML Filter</button>");
    html.find(".directory-footer").append(filterButton);

    filterButton.click(async (ev) => {
        console.log("htmlfilter | button clicked");
...
Hooks.once('init', async function () {
	...
	game.settings.register('htmlfilter', 'filter', {
	  ...
	  onChange: value => { // value is the new value of the setting
		console.log('htmlfilter | filter: ' + value)
	  },
	});
	...
	game.settings.register('htmlfilter', 'spellbook', {
	  ...
	  default: false,
	  onChange: value => { // value is the new value of the setting
		console.log('htmlfilter | spellbook: ' + value)
	  },
	});
	game.settings.register('htmlfilter', 'ignore', {
	  ...
	  onChange: value => { // value is the new value of the setting
		console.log('htmlfilter | ignore: ' + value)
	  },
	});
	game.settings.register('htmlfilter', 'imgheight', {
	  ...
	  default: 150,
	  onChange: value => { // value is the new value of the setting
		console.log('htmlfilter | image height: ' + value)
	  },
	});
